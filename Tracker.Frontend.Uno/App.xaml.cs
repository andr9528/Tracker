...
public partial class App : Application
{
    ...
    protected override async void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        IApplicationBuilder builder = this.CreateBuilder(args)
            ...
            .UseToolkitNavigation().Configure(host => host
#if DEBUG
                ...
                }, true).UseSerilog(true, true).UseConfiguration(configure: configBuilder =>
                    configBuilder.EmbeddedSource<App>().Section<AppConfig>())
                // Enable localization (see appsettings.json for supported languages)
                .UseLocalization().ConfigureServices((context, services) =>
                {
    ...
    private static void RegisterRoutes(IViewRegistry views, IRouteRegistry routes)
    {
        ...
        routes.Register(new RouteMap("", views.FindByViewModel<ShellModel>(), Nested: new RouteMap[]
        {
            ...
            new("Second", views.FindByViewModel<SecondModel>()),
        }));
    }
}
