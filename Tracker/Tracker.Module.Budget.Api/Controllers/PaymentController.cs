...
namespace Tracker.Module.Budget.Api.Controllers
{
    ...
    [ApiController]
    public class PaymentController : EntityController<Payment, SearchablePayment>
    {
        /// <inheritdoc />
        public PaymentController(IEntityQueryManager<Payment, SearchablePayment> manager) : base(manager)
        {
        }
    }
}